...
def load_best_model(filename, data_dir=MODELS_DIR):
    """
    Args:
        filename (string): The name of the file to load.
        data_dir (string, optional): The name of the directory to load from. Defaults to MODEL_DIR.
...
def plot_hexbin_parity(true_vals, predicted_vals, params, filename="parity-plot.png"):
...
def check_reg_errors(
    ...
    """
    Args:
        model_file (string): The name of the model file to load.
        data_file (string): The name of the data file to load.
        use_test_set (bool, optional): Whether to use the test set. Defaults to False.
        check_baseline (bool, optional): Whether to include baseline metrics. Defaults to False.
        parity_plot (bool, optional):  Whether to include a parity plot. Defaults to False.
