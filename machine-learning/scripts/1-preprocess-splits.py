...
SIMULATION_OUTPUT_DIR = os.path.join(
    "..", "..", "microkinetic-modeling", "simulation-output"
)
TRAINING_DATA_DIR = os.path.join("..", "training-data")


def load_data(filename, data_dir=SIMULATION_OUTPUT_DIR):
    """
    Args:
        filename (string): The name of the file to load.
        data_dir (string, optional): The name of the directory to load from. Defaults to SIMULATION_OUTPUT_DIR.
...
def save_data(df, filename, data_dir=TRAINING_DATA_DIR):
    """
    Args:
        df (pandas.DataFrame): The dataframe to save.
        filename (string): The name of the file to save.
        data_dir (string, optional): The name of the directory to save to. Defaults to TRAINING_DATA_DIR.
    """
...
def main():
    ...
    rc_cols_to_remove = shared_cols_to_remove
    ...
    for filename, removals, tag in zipped_specs:
        ...
        # We are only interested in the steady state data for the ML models
