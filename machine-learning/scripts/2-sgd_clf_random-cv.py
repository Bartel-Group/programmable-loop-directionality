...
def search_random_params(
    ...
    save_dir=SAVE_DIR,
    save_best=True,
    best_name="sgd_clf_best-estm.pkl",
    remake=False,
):
    """
    Args:
        ...
        filename (string, optional): The name of the file to save the search. Defaults to "sgd_clf.pkl".
        ...
        best_name (string, optional): The name of the file to save the best estimator. Defaults to "sgd_clf_best-estm.pkl".
...
def main():
    ...
    for tag in tags:
        ...
        param_dists = {
            "classifier__alpha": st.uniform(loc=0.0001, scale=9.9999),
            "classifier__max_iter": st.randint(1000, 5000),
        ...
        rs = search_random_params(
            ...
            filename="sgd_clf_" + tag + ".pkl",
            save_dir=pkls_subdir,
            save_best=True,
            best_name="sgd_clf_" + tag + "-best-estm.pkl",
            remake=True,
        )
