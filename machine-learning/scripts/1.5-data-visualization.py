...
def plot_histogram(df, filename="TOF_histogram.png"):
    ...
    pos_df, neg_df, _ = split_TOFs_by_sign(df)
...
def plot_BEA_histogram(df, filename="BEA_histogram.png"):
    ...
    ax.yaxis.set_minor_locator(ticker.LogLocator(base=10.0, subs=(1.0, 2.0, 5.0)))
