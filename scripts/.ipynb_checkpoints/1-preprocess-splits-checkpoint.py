...
def main():
    ...
    filenames = ["240212_original_params_all.csv", "240212_rate_constants_all.csv"]
    tags = ["op", "rc"]
    ...
    for filename, removals, tag in zipped_specs:
        ...
        save_data(df_steady, f"240219_{tag.lower()}_steady.csv")
        save_data(df_transient, f"240219_{tag.lower()}_transient.csv")
