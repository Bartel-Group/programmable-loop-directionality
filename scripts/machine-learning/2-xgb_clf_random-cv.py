...
SEED = 17
DATA_DIR = "/home/cbartel/noord014/projects/programmable-catalysis/data/rc_steady/classification/csvs"
SAVE_DIR = "/home/cbartel/noord014/projects/programmable-catalysis/data/rc_steady/classification/pkls"
...
def search_random_params(
    ...
    filename="xgb_clf_rc-random-cv.pkl",
    save_dir=SAVE_DIR,
    save_best=True,
    best_name="xgb_clf_rc-best-estm.pkl",
    remake=False,
):
    """
    Args:
        ...
        filename (string, optional): The name of the file to save the search. Defaults to "xgb_clf_random-cv.pkl".
...
def main():
    ...
    rs = search_random_params(
        ...
        filename="xgb_clf_rc-random-cv-not-scaled-features.pkl",
        save_dir=SAVE_DIR,
        save_best=True,
        best_name="xgb_clf_rc-best-estm-all-not-scaled.pkl",
        remake=True,
    )
